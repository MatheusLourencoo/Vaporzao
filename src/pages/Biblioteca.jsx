      ...
      {jogoParaRemover && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="bg-[#18181b] border border-white/10 p-6 rounded-xl max-w-sm w-full shadow-2xl animate-in zoom-in-95 duration-200">
            <h2 className="text-xl font-bold text-white mb-2">Remover Jogo?</h2>
            <p className="text-zinc-400 text-sm mb-6 leading-relaxed">
              Deseja remover <strong>"{jogoParaRemover.titulo || 'Jogo Desconhecido'}"</strong> da sua biblioteca?
            </p>
            <div className="flex gap-3">
              ...
              <button 
                onClick={() => {
                  removerDaBiblioteca(jogoParaRemover.id || jogoParaRemover.jogoId);
